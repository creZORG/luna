...
interface OnlineOrdersClientProps {
  initialOrders: Order[];
}
...
export default function OnlineOrdersClient({ initialOrders }: OnlineOrdersClientProps) {
  ...
  return (
     <Card>
        <CardHeader>
            <CardTitle>Online Customer Orders</CardTitle>
            <CardDescription>
                A real-time list of all orders placed through the website.
            </CardDescription>
        </CardHeader>
        <CardContent>
