...
import { Loader, Package, Truck, Warehouse, MapPin, CheckCheck, LayoutDashboard, Factory } from "lucide-react";
...
const operationsNavLinks = [
    ...
    { href: '/operations/raw-materials/manage', label: 'Manage Materials', icon: Factory },
