    ...
    >
      ...
      >
        <span className="relative h-6 w-6 flex items-center justify-center rounded-full bg-background shadow-md">
            <Sun className="h-4 w-4 text-yellow-500 transition-all duration-300 ease-in-out opacity-100 dark:opacity-0 dark:scale-0 dark:rotate-90" />
            <Moon className="absolute h-4 w-4 text-slate-400 transition-all duration-300 ease-in-out opacity-0 dark:opacity-100 dark:scale-100 dark:rotate-0" />
             <Star className="absolute h-2 w-2 right-1 top-1 text-slate-400 transition-all duration-300 ease-in-out opacity-0 dark:opacity-100 dark:scale-100 dark:rotate-0" />
        </span>
      </span>
    </button>
  )
