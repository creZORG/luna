...
export async function logActivity(description: string, userId: string, userName: string): Promise<string> {
    try {
...
export async function getRecentActivities(count: number = 50): Promise<ActivityLog[]> {
    try {
        const q = query(
